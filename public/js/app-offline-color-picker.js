...
var ColorPickerManager = /*#__PURE__*/function () {
  function ColorPickerManager(isOnline) {
    var isHost = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    _defineProperty(this, "additionalFunc", function () {});
  ...
  _createClass(ColorPickerManager, [{
    ...
    value: function initOnlineSettings(isHost) {
      var _this = this;
    ...
    key: "setPlayerOnePicker",
    value: function setPlayerOnePicker() {
      this._addOptionListener(this._xPickerOtions, this._playerOneTxt, "_playerOnePick", "_playerTwoPick");
    }
  }, {
    key: "setPlayerTwoPicker",
    value: function setPlayerTwoPicker() {
    ...
    key: "enableBtnByPick",
    value: function enableBtnByPick(btnName) {
...
/***/ "./resources/js/managers/questionCategoryManager.js":
/*!**********************************************************!*\
  !*** ./resources/js/managers/questionCategoryManager.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var questionCategoryManager = /*#__PURE__*/function () {
  function questionCategoryManager() {
    _classCallCheck(this, questionCategoryManager);

    _defineProperty(this, "_options", document.querySelectorAll(".question-category"));
  ...
  _createClass(questionCategoryManager, [{
    key: "_init",
    value: function _init() {
      ...
      this._options.forEach(function (option) {
        option.addEventListener("click", function (e) {
          ...
          if (_this.selected === _this._options.length) {
            _this.selected = 0;
          }

          _this._options[_this.selected].classList.add("selected");
        });
      });
    }
  }, {
    key: "selectedName",
    value: function selectedName() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new questionCategoryManager());

/***/ }),

/***/ "./resources/js/offline-color-picker.js":
/*!**********************************************!*\
  !*** ./resources/js/offline-color-picker.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _helper_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helper/loader */ "./resources/js/helper/loader.js");
/* harmony import */ var _managers_questionCategoryManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./managers/questionCategoryManager */ "./resources/js/managers/questionCategoryManager.js");
/* harmony import */ var _managers_colorPickerManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./managers/colorPickerManager */ "./resources/js/managers/colorPickerManager.js");
...
var onLoad = function onLoad() {
  ...
  colorPickerManager = new _managers_colorPickerManager__WEBPACK_IMPORTED_MODULE_4__["default"](false);
};
...
btnStart.addEventListener("click", function (e) {
  ...
  var interval = setInterval(function () {
    ...
    var categoryId = _managers_questionCategoryManager__WEBPACK_IMPORTED_MODULE_3__["default"].selectedId();
    clearInterval(interval);
    window.location.href = "/offline-game/".concat(locale, "?host_color=").concat(colors.host_color, "&join_color=").concat(colors.join_color, "&question_category_id=").concat(categoryId);
  }, 500);
});
...
/*!**************************************************!*\
  ...
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _offline_color_picker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./offline-color-picker */ "./resources/js/offline-color-picker.js");
